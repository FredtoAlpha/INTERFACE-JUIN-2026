...
const CHECKS = {
  ...
  COM     :{required:false, validator:v=>v===''||v===null||v===undefined||(!isNaN(Number(v))&&Number(v)>=0&&Number(v)<=5), message:'Note COM invalide (doit être 0-5 ou vide)'},
  TRA     :{required:false, validator:v=>v===''||v===null||v===undefined||(!isNaN(Number(v))&&Number(v)>=0&&Number(v)<=5), message:'Note TRA invalide (doit être 0-5 ou vide)'},
  PART    :{required:false, validator:v=>v===''||v===null||v===undefined||(!isNaN(Number(v))&&Number(v)>=0&&Number(v)<=5), message:'Note PART invalide (doit être 0-5 ou vide)'},
